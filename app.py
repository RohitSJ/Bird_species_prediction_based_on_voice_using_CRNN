...
try:
    audio_model = tf.keras.models.load_model('D:/Bird_species_prediction_project/models/best_bird_model.h5')
...
try:
    image_model = load_model('D:/Bird_species_prediction_project/models/bird_classifier.h5')
    with open('D:/Bird_species_prediction_project/models/class_indices.pkl', 'rb') as f:
